    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column min-width="300px" label="公司名称" fixed="left">
        <template slot-scope="{row}">
          <router-link :to="'/high-seas-customer/edit/'+row.uuid" class="link-type">
      ...
      <el-table-column align="center" label="操作" width="290" fixed="right">
        <template slot-scope="scope">
          ...
          <router-link :to="'/high-seas-customer/edit/'+scope.row.uuid">
...
import { fetchCustomerList, protect, del } from '@/api/customer'

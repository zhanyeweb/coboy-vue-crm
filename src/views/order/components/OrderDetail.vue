          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label-width="120px" label="订单总金额:" prop="OrderAmount" class="postInfo-container-item">
                <el-input-number v-model="postForm.OrderAmount" disabled :precision="2" :step="1" :max="999999999" placeholder="请输入订单总金额" />
              </el-form-item>
            </el-col>
            ...
            <el-col :span="8">
              <el-form-item label-width="120px" label="欠款:" class="postInfo-container-item">
                <el-input-number v-model="postForm.arrears" disabled :precision="2" :step="1" :max="999999999" placeholder="请输入欠款" />
              </el-form-item>
            </el-col>
          </el-row>
        </div>

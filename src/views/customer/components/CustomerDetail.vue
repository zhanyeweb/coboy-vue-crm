  ...
  <div class="createPost-container">
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <div class="createPost-main-container">
        <el-row>
          ...
          <el-col :span="24">
            ...
            <div class="postInfo-container">
              <el-row>
                <el-col :span="8">
                  <el-form-item label-width="60px" label="业务员:" class="postInfo-container-item">
                ...
                <el-col :span="8">
                  <el-form-item label-width="100px" label="主要联系人:" class="postInfo-container-item">
            ...
            <div class="postInfo-container">
              <el-row>
                <el-col :span="8">
                  <el-form-item label-width="60px" label="职位:" class="postInfo-container-item">
                ...
                <el-col :span="8">
                  <el-form-item label-width="60px" label="邮箱:" class="postInfo-container-item">
            ...
            <div class="postInfo-container">
              <el-row>
                <el-col :span="8">
                  <el-form-item label-width="100px" label="展厅数量:" class="postInfo-container-item">
                ...
                <el-col :span="8">
                  <el-form-item label-width="100px" label="联系进度:" class="postInfo-container-item">
        ...
        <el-form-item style="margin-bottom: 40px;" label-width="70px" label="地址:">
          <el-input v-model="postForm.address" :rows="1" type="textarea" class="article-textarea" autosize placeholder="请输入地址" />
          <span v-show="contentShortLength" class="word-counter">{{ contentShortLength }}words</span>
        </el-form-item>

        <el-form-item style="margin-bottom: 40px;" label-width="70px" label="网站:">
